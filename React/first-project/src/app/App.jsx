...
//mechanism eka use karanna ona
  return (
    ...
    <Button onClick={()=>{
      setCount(count+1);
    }} name={'Add Button'}  style={{backgroundColor:'green'}}/>
    <Button onClick={click2} name={'Update Button'} style={{backgroundColor:'black'}}/>
    <Button onClick={click3} name={'Delete Button'}  style={{backgroundColor:'red'}}/>
    <Button />
